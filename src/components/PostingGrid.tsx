...
const PostingGrid = () => {
  ...
  const API_URL = "http://localhost:5000/api/postings";
  ...
  return (
    <div className="container mx-auto p-5">
      ...
      <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[960px] ml-[240px]">
        {posts.map((post) => {
          ...
          return (
            <Link key={post._id} to={`/postinggrid/${post._id}`}>
